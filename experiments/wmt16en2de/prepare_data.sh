...
OUTPUT_DIR="$PROJ_DIR/data/wmt16deen/corpus"
...
for f in ${OUTPUT_DIR}/train.tok.clean.en ${OUTPUT_DIR}/valid.tok.en ${OUTPUT_DIR}/test.tok.en; do
  fbase=${f%.*}
...
for merge_ops in 32000; do
  ...
  cat "${OUTPUT_DIR}/train.tok.clean.tok.de" "${OUTPUT_DIR}/train.tok.clean.tok.en" | \
