...
from fairseq.modules import (
    AdaptiveInput, AdaptiveSoftmax, CharacterTokenEmbedder, LearnedPositionalEmbedding, MultiheadLISA,
    SinusoidalPositionalEmbedding
)

from . import (
    FairseqIncrementalDecoder, FairseqTagsEncoder, FairseqTagsModel, FairseqLanguageModel, register_model,
...
class LISATransformerEncoder(FairseqTagsEncoder):
    ...
    def forward(self, src_tokens, src_lengths, src_tags):
        ...
        if self.gold_parses and not self.training:
            l = src_tags.size(1) - 1
            parse_heads = torch.cuda.FloatTensor(np.vectorize(lambda e: self.map_dictionary.get(e, l))(src_tags))
        else:
            parse_heads = None
